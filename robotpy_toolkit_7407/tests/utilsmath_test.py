...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            math.pi / 3,
            (
                math.sqrt(2) * math.cos(13 * math.pi / 12),
                math.sqrt(2) * math.sin(13 * math.pi / 12),
            ),
        ),
        (
            3,
            ...
            13 * math.pi / 6,
            (
                math.sqrt(13) * math.cos(math.atan2(-2, 3) + math.pi / 6),
                math.sqrt(13) * math.sin(math.atan2(-2, 3) + math.pi / 6),
            ),
        ),
        (
            -5.2,
            ...
            4.7,
            (
                math.sqrt(5.2**2 + 2.3**2) * math.cos(math.atan2(-2.3, -5.2) + 4.7),
                math.sqrt(5.2**2 + 2.3**2) * math.sin(math.atan2(-2.3, -5.2) + 4.7),
            ),
        ),
    ],
)
